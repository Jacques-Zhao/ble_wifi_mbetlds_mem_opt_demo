...
bleprph_on_sync(void)
{
    ...
    /* Begin advertising. */
    bleprph_advertise();
    printf("BLE advertise, Heap: %lu, min heap: %lu\n", esp_get_free_heap_size(), esp_get_minimum_free_heap_size());
}
...
{
    int rc;
    printf("App main start, Heap: %lu, min heap: %lu\n", esp_get_free_heap_size(), esp_get_minimum_free_heap_size());
    ...
    ESP_LOGI(TAG, "power save on");
    wifi_init_sta();
    printf("WiFi init, Heap: %lu, min heap: %lu\n", esp_get_free_heap_size(), esp_get_minimum_free_heap_size());
    ...
    printf("WiFi + BLE init, Heap: %lu, min heap: %lu\n", esp_get_free_heap_size(), esp_get_minimum_free_heap_size());
